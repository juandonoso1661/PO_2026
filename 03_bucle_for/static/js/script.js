...
function filaEspera() {
    ...
    let vacio = []
    let arreglo = document.getElementById(`resultadoArreglo`);
...
function reordenarDatos() {
    ...
    resultado.textContent = `Total numero de estudiantes aprovados = ${contadorAprobados}`;
    container.classList.remove(`d-none`);
};
...
function contadorPantalla() {
    ...
    result1.textContent = `Contador: ${numeros.join(" - ")}`;
    container.classList.remove('d-none');
}
...
function asistenciaAutomatica() {
    let curso = ["Ana", "Diego", "Sofía", "Matias"];
    let resultado = [];
    const container2 = document.getElementById('resultadoContainer2');
...
function buscadorAprobados() {
    let notas = [3.5, 6.2, 5.0, 2.8, 4.5, 7.0];
    let contadorAprobados = 0;
    const container3 = document.getElementById('resultadoContainer3');
    ...
    result3.textContent = `Contador: ${contadorAprobados}`;
...
function controlStock() {
    let productos = ["Teclado", "Mouse", "Agotado", "Monitor", "Agotado", "Audífonos"];
    let resultado = [];
    const container4 = document.getElementById('resultadoContainer4');
    ...
    result4.textContent = resultado.join(", ");
...
function sumandoColecta() {
    ...
    const container5 = document.getElementById('resultadoContainer5');
...
function nombresVip() {
    ...
    let resultado = [];
    const container6 = document.getElementById('resultadoContainer6');
...
function stockEspecifico() {
    ...
    const container7 = document.getElementById('resultadoContainer7');
